...
inline Texture::Texture(const char* image, const char* texType, GLenum texFormat, GLuint slot, GLenum colorChannels, GLenum pixelType)
{
...
inline void Texture::texUnit(Shader& shader, const char* uniform, GLuint unit)
{
